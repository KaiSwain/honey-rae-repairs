...
export const TicketList = () => {
  ...
  useEffect(() => {
    if (showEmergencyOnly) { //if its true then run this code
      const emergencyTickets = allTickets.filter( //make a new variable filled with
    ...
    } else { //if its false set filtered tickets to all tickets
